...
const defContacts = [
  {
    _id: '5a56446769f443a5d64b32ca',
    name: 'Beny "אני יודע מה הבעיה שלך" Shtrudel',
    email: 'beku1922@fake.com',
    phone: '+1 (962) 597-3827',
    coins: '1000000',
    transactions: [],
  },
  {
...
function transfer(to, from, amount) {
  if (from.coins - amount < 0) throw new Error('Not enough balance');
  to.coins += amount;
  from.coins -= amount;
...
function _loadContacts() {
  ...
  if (!contacts || !contacts.length) contacts = defContacts;
